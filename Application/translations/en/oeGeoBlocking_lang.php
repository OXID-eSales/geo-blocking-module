...
$aLang = [
    ...
    'OEGEOBLOCKING_HINT'                   => "We don't deliver to the chosen country. Please select or provide a different address in the shipping address section.",
    ...
    'OEGEOBLOCKING_PICKUP_ADDRESS_CHANGE_NOT_ALLOWED'    => "It is not allowed to change this shipping address, please select existing or add new one.",
];
